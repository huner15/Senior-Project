...
public class npcSprite : MonoBehaviour
{
    ...
    private void initSprite()
    {
        ...
        zoom_mouth = Instantiate(_zoom_outline_mouth[_neutral], new Vector3(0.5f, 0.5f, 0), Quaternion.identity) as GameObject;
        ...
        zoom_eyes = Instantiate(_zoom_outline_eyes[_normal], new Vector3(0.5f, 0.5f, 0), Quaternion.identity) as GameObject;
        zoom_eye_color = Instantiate(_zoom_eyes, new Vector3(0.5f, 0.5f, 0), Quaternion.identity) as GameObject;
        ...
        zoomHair = Instantiate(_zoom_hair[spriteType], new Vector3(0.5f, 0.5f, 0), Quaternion.identity) as GameObject;
        zoomHair.GetComponent<SpriteRenderer>().color = haircolor;
        zoomHairOutline = Instantiate(_zoom_outline_hair[spriteType], new Vector3(0.5f, 0.5f, 0), Quaternion.identity) as GameObject;
        ...
        zoomSkin = Instantiate(_zoom_face, new Vector3(0.5f, 0.5f, 0), Quaternion.identity) as GameObject;
        ...
        zoomTop = Instantiate(_zoom_shirt, new Vector3(0.5f, 0.5f, 0), Quaternion.identity) as GameObject;
        ...
        zoomOutline = Instantiate(_zoom_outline, new Vector3(0.5f, 0.5f, 0), Quaternion.identity) as GameObject;
    ...
    public void setState(string state)
    {
        ...
        else if (state.Equals("happy"))
        {
            ...
            Destroy(zoom_eyes);
            mouth = Instantiate(_mouth[mouthType]) as GameObject;
            zoom_mouth = Instantiate(_zoom_outline_mouth[_smile], new Vector3(0.5f, 0.5f, 0), Quaternion.identity) as GameObject;
            zoom_eyes = Instantiate(_zoom_outline_eyes[_normal], new Vector3(0.5f, 0.5f, 0), Quaternion.identity) as GameObject;
        }
        ...
        else if (state.Equals("sad") || state.Equals("angry"))
        {
            Destroy(zoom_mouth);
            Destroy(zoom_eyes);
            zoom_mouth = Instantiate(_zoom_outline_mouth[_frown], new Vector3(0.5f, 0.5f, 0), Quaternion.identity) as GameObject;
            zoom_eyes = Instantiate(_zoom_outline_eyes[_sad], new Vector3(0.5f, 0.5f, 0), Quaternion.identity) as GameObject;
        }
